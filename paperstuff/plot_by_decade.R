...
ment=read.csv("/Users/ps22344/Downloads/ota-master/outputfiles/output_overall_1399to1700.csv", sep="\t", header=T)
summary(ment)
colnames(ment)
head(ment[,45])
...
#le'ts puts ome conmaes here at some point
totalwords;
...
t
#all in one plot
png(paste("allgenres_1499to1600", ".png"), width=960, height=640, res=100);
print ("start")
count=1;
